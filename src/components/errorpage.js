...
<div id="page" class="hfeed site">
        <header id="masthead" class="site-header" style={{background: "url(assets/img/slider-bg.jpg)"}} >
            ...
            <div id="content" className="site-content">
                <div id="primary" className="content-area">
                    ...
                    <main id="main" className="site-main">
                        <div className="error-404 not-found" style={{ background: "url(assets/img/error-bg.jpg)" }}>
